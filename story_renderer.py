...
def story_schedule(path):
    ...
    centered(draw, "09:00  OWNER CHOICE", 820, 70, WHITE)
    centered(draw, "13:00  REAL VS BATTLE", 940, 70, WHITE)
    centered(draw, "19:30  COMMENT WAR", 1060, 70, WHITE)
    centered(draw, "22:45  NIGHT BATTLE", 1180, 70, WHITE)
